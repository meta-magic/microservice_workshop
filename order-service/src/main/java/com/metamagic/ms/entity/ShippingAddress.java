 ...
 *
 */
@PersistenceCapable(table = "shipping_address", detachable = "true")
public class ShippingAddress {
	 ...
	 * @throws InvalidDataException
	 */
	public void updateShippingAddress(String label, String address, String country, String province, String postalcode,
			String city) throws InvalidDataException {
		this.setLabel(label);
		this.setAddress(address);
		this.setCountry(country);
		this.setProvince(province);
